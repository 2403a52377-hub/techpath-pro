...
const FEATURES = [
  { icon: Map, title: "Personalized Roadmaps", desc: "Beginner → Advanced step-by-step paths across 14 engineering career domains." },
  { icon: Code2, title: "Coding Practice", desc: "Curated DSA, company-tagged & contest problems on LeetCode, HackerRank & more." },
  { icon: Bot, title: "TechLand AI", desc: "Your 24/7 AI career coach — resume review, mock interviews, study plans." },
  { icon: FileText, title: "ATS Resume Builder", desc: "Premium templates, real-time scoring, one-click PDF & LinkedIn sync." },
  { icon: Briefcase, title: "Placement Prep", desc: "Aptitude, reasoning, mock tests and dedicated tracks for top companies." },
  { icon: Trophy, title: "Gamified Growth", desc: "XP, badges, streaks and leaderboards to keep you shipping every day." },
];

const COMPANIES = ["Google", "Amazon", "Microsoft", "TCS", "Infosys", "Accenture", "Wipro", "Cognizant"];
    ...
    <div className="min-h-screen">
      ...
      <nav className="sticky top-0 z-50 backdrop-blur-xl bg-background/70 border-b border-border/60">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2">
            <div className="size-9 rounded-xl bg-gradient-primary grid place-items-center text-primary-foreground font-bold shadow-glow">T</div>
            <span className="text-xl font-bold gradient-text">TechLand</span>
          </Link>
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-muted-foreground">
            <a href="#features" className="hover:text-foreground">Features</a>
            <a href="#roadmaps" className="hover:text-foreground">Roadmaps</a>
          ...
          <div className="flex items-center gap-3">
            ...
            <Button variant="hero" asChild><Link to="/auth" search={{ tab: "signup" }}>Get Started</Link></Button>
          </div>
        </div>
      </nav>
        ...
        <div className="max-w-7xl mx-auto px-6 relative">
          <div className="max-w-3xl">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold tracking-tight leading-[1.05]">
              From <span className="gradient-text">first line of code</span><br />
              to your dream offer letter.
            </h1>
            <p className="mt-6 text-lg sm:text-xl text-muted-foreground max-w-2xl">
              TechLand is your end-to-end career ecosystem — roadmaps, coding practice, mock interviews,
              resume builder, mentorship and an AI coach, all in one premium platform built for engineers.
            </p>
            ...
            <div className="mt-10 flex flex-wrap items-center gap-x-8 gap-y-3 text-sm text-muted-foreground">
              {["Free for students", "14 career domains", "Institute email verified", "AI mock interviews"].map((t) => (
          ...
          <div className="mt-16 lg:absolute lg:right-6 lg:top-32 lg:mt-0 lg:max-w-md w-full">
            <div className="glass-card rounded-2xl p-6 shadow-elegant">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="size-12 rounded-xl bg-gradient-accent grid place-items-center"><Trophy className="size-6 text-accent-foreground" /></div>
              </div>
      ...
      <section id="features" className="py-24">
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-2xl">
            <p className="text-sm font-semibold text-accent uppercase tracking-widest">Everything you need</p>
            <h2 className="mt-3 text-4xl lg:text-5xl font-bold">A complete career ecosystem.</h2>
            <p className="mt-4 text-lg text-muted-foreground">
              Stop juggling 15 tabs. TechLand brings learning, practice, preparation, and placement under one roof.
            </p>
          </div>
          <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {FEATURES.map((f) => {
              const Icon = f.icon;
              return (
                <div key={f.title} className="group glass-card rounded-2xl p-6 hover:shadow-elegant hover:-translate-y-1 transition-all">
      ...
      <section id="roadmaps" className="py-24 bg-background/40 border-y border-border/60">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="mt-4 text-lg text-muted-foreground max-w-2xl">
            14 industry-aligned career roadmaps designed with mentors from Google, Amazon, Microsoft and IITs.
          </p>
          <div className="mt-10 flex flex-wrap gap-3">
            {[
              "Full Stack","Frontend","Backend","Data Analyst","Data Scientist","AI/ML",
              "Cybersecurity","Cloud","DevOps","Mobile","UI/UX","Blockchain","Testing","Analytics",
            ].map((d) => (
              <span key={d} className="px-4 py-2 rounded-full glass-card text-sm font-medium hover:shadow-glow transition-shadow cursor-default">
                {d}
              </span>
            ))}
          </div>
      ...
      <section id="companies" className="py-24">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <p className="text-sm font-semibold text-accent uppercase tracking-widest">Dedicated tracks</p>
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="relative overflow-hidden rounded-3xl bg-gradient-hero p-12 lg:p-16 shadow-elegant">
            ...
            <div className="relative">
              ...
              <h2 className="text-4xl lg:text-5xl font-bold text-primary-foreground">Your offer letter starts here.</h2>
              <p className="mt-4 text-lg text-primary-foreground/80 max-w-2xl">
                Join thousands of engineering students already shipping projects, cracking interviews, and landing offers with TechLand.
              </p>
              <div className="mt-8 flex flex-wrap gap-4">
                <Button size="xl" className="bg-background text-foreground hover:bg-background/90" asChild>
                  <Link to="/auth" search={{ tab: "signup" }}>Create free account <ArrowRight className="size-4" /></Link>
                </Button>
              </div>
            </div>
          </div>
      ...
      <footer className="border-t border-border/60 py-12">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <p className="text-sm text-muted-foreground">Built for engineering students. Powered by AI.</p>
          <div className="flex gap-4 text-muted-foreground">
            <a href="#" aria-label="GitHub"><Github className="size-5 hover:text-foreground" /></a>
            <a href="#" aria-label="LinkedIn"><Linkedin className="size-5 hover:text-foreground" /></a>
          </div>
        </div>
      </footer>
    </div>
