  ...
  return (
    <AppShell>
      <PageHeader
        ...
        subtitle="Curated DSA paths across the best platforms. Topic-wise, company-wise, and daily challenges."
      />
      ...
      <section className="mt-10">
        <h2 className="text-xl font-bold flex items-center gap-2">
          <Flame className="size-5 text-accent" /> Topic-wise practice
        </h2>
        {!topics && (
      ...
      <section className="mt-10">
        <h2 className="text-xl font-bold flex items-center gap-2">
          <Trophy className="size-5 text-accent" /> Company-tagged questions
        </h2>
        <div className="mt-4 grid sm:grid-cols-2 lg:grid-cols-4 gap-3">
          {COMPANIES.map((c) => (
            <a
              key={c.slug}
              href={`https://leetcode.com/company/${c.slug}/`}
              target="_blank"
              rel="noreferrer"
