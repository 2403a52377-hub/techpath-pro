  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const [u, r, j, p, jl, rl] = await Promise.all([
        ...
        supabase
          .from("jobs")
          .select("id,role,company_name,location,posted_at")
    ...
    <AppShell>
      <div className="mb-8">
        ...
        <p className="text-muted-foreground mt-2">
          Manage roadmaps, jobs, and monitor the community.
        </p>
      </div>
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        <div className="glass-card rounded-2xl p-6">
          ...
          <div className="space-y-3">
            <input
              className="w-full px-3 py-2 rounded-lg bg-background/60 border border-border"
            ...
            <div className="grid grid-cols-2 gap-3">
              <input
                className="px-3 py-2 rounded-lg bg-background/60 border border-border"
            ...
            />
            <Button variant="hero" onClick={addJob} className="w-full">
              Publish job
            </Button>
          </div>
        </div>
